...
class TestDevelopmentConfig(TestCase):
    ...
    def test_app_in_development(self):
        ...
        :return:
        """
        self.assertFalse(app.config['SECRET_KEY'] is 'wrong key')
        ...
        self.assertTrue(app.config['SQLALCHEMY_DATABASE_URI'] ==
                        os.getenv('DATABASE_URL', "postgresql://postgres:postgres@localhost/api"))
...
class TestTestingConfig(TestCase):
    ...
    def test_app_in_testing(self):
        ...
        self.assertFalse(current_app is None)
        self.assertTrue(app.config['SQLALCHEMY_DATABASE_URI']
                        == os.getenv('DATABASE_URL_TEST', "postgresql://postgres:postgres@localhost/api_test"))
